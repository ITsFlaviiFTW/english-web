...
export default function RandomQuizPage() {
  ...
  const handleSubmit = async () => {
    ...
    setError("")
    try {
      // Submit as attempts against the *first* lesson for XP consistency
      // Alternatively, you could add a dedicated POST /quiz/random/attempts/ if desired.
      // Here we bucket by lesson id; pick any valid lesson if mixed.
