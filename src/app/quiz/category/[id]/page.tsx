  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        setError("Nu am putut încărca testul pe categorie");
      } finally {
        setIsLoading(false);
      }
    })();
    ...
    <Protected>
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-2xl font-bold">Test pe categorie</h2>
        ...
        <div className="flex items-center justify-between">
          <Button onClick={() => (currentIdx > 0 ? setCurrentIdx((i) => i - 1) : undefined)} disabled={currentIdx === 0} variant="outline">
            Înapoi
          </Button>
